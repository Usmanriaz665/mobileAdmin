...
class MobilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mobile" do
    assert_difference('Mobile.count') do
      post mobiles_url, params: { mobile: { color: @mobile.color, discription: @mobile.discription, model: @mobile.model, price: @mobile.price, title: @mobile.title } }
    end
  ...
  test "should update mobile" do
    patch mobile_url(@mobile), params: { mobile: { color: @mobile.color, discription: @mobile.discription, model: @mobile.model, price: @mobile.price, title: @mobile.title } }
